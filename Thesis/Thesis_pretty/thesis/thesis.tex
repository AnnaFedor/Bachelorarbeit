...
\newcommand{\headtitle}{Vision-based Object Grasping with Deep Reinforcement Learning in Simulation }
\newcommand{\floatingtitle}{Vision-based Object Grasping with Deep Reinforcement Learning in Simulation }
\newcommand{\thesistype}{Bachelor thesis}

\newcommand{\reviewerone}{Prof.~Dr.-Ing.~R.~Dillmann}
\newcommand{\reviewertwo}{Prof. Dr.-Ing. R. Stiefelhagen}
\newcommand{\advisor}{M. Sc. Atanas Tanev}

\newcommand{\timestart}{1st January 2020}
\newcommand{\releaseyear}{2020}
\newcommand{\timeend}{15th June \releaseyear}
\newcommand{\releasemonth}{June \releaseyear}
...
\newcommand{\titlefig}{\includegraphics[width=0.8\textwidth]{graphics/ppo_with_rotation}}
