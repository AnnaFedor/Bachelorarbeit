...
\begin{table}[H]
	...
	\end{center}
	\label{exampletab}
	\caption{Hyperparameters for for the applied PPO algorithm. These are the default parameters set for PPO in the stable baselines library.}
\end{table}
