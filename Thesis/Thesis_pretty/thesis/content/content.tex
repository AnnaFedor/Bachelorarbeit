...
In the same paper a detailed overview of the data-driven grasp synthesis approaches was presented \ref{figure:grasp_hypothesis}. Grasp synthesis is defined as "the problem of finding a grasp configuration that satisfies a set of criteria relevant for the grasping task". Data-driven or also called empirical approaches sample various grasp candidates and then rank them using different strategies. \\
\begin{figure}[H]
	\centering
