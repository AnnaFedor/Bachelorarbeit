...
One of the strategies is to compare the candidate grasp to labeled examples.  \cite{redmon2015real} use the Cornell grasping dataset to compare the sampled grasps to the ground truth grasps from the Dataset.
...
. To study grasp planning at scale, Goldfeder
et al. [12], [13] developed the Columbia grasp database,
a dataset of 1,814 distinct models and over 200,000 force
closure grasps generated using the GraspIt! sampling-based
grasp planner. Pokorny et al. [34] introduced Grasp Moduli
Spaces, enabling joint grasp and shape interpolation, and
analyzed a set of 100 million sampled grasp configurations.
