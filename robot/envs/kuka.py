...
class Kuka:
    ...
    def __init__(self, urdfRootPath=data.getDataPath(), timeStep=0.01):
        self.urdfRootPath = urdfRootPath
        self.timeStep = timeStep
        # maxVelocity = 1 hat besser funktioniert, als bei setJointsMotorControl2()...targetVelocity und velocityGain auskommentiert wurden, dz = -0,002
        # bei 0,02 scheisse
        # self.maxVelocity = .35
        self.maxVelocity = 1
        self.maxForce = 200.
    ...
    def reset(self):
        ...
        # self.trayUid = p.loadURDF(os.path.join(self.urdfRootPath, "table/table.urdf"), 0.5000000, 0.00000, -.820000,
    ...
    def applyAction1(self, targetPosition):
        ...
        if self.useInverseKinematics:
            ...
            self.endEffectorPos[0] = targetPosition[0]
            self.endEffectorPos[1] = targetPosition[1]
            self.endEffectorPos[2] = targetPosition[2]
            fingerAngle = 0.3

            if self.endEffectorPos[0] > 0.7:
                self.endEffectorPos[0] = 0.7
            if self.endEffectorPos[0] < 0.4:
                self.endEffectorPos[0] = 0.4
        ...
        # print("actualEndEffectorPos: ", actualEndEffectorPos)
        # print("positional Difference: ", actualEndEffectorPos[0] - pos[0], actualEndEffectorPos[1] - pos[1],
        #      actualEndEffectorPos[2] - pos[2])
